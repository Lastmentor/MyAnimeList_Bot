...
namespace MyAnimelist_Friend_Bot
{
    class Program
    {
        ...
        {            
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (isComment > 0 && commentFriend == "Y")
                                {
                                    ...
                                    comments.SendKeys("Hi there, i like watching anime and talk about it so i'm looking for friends.");
            ...
            {                
                js.ExecuteScript("alert('No Account Wrong Information Program Shuting Down In 2 Seconds');");
                Thread.Sleep(2000);
                driver.Quit();
            }           
        }  
